...
img_main = pygame.image.load('lab_7\\mouse\\mainclock.png')
img_main = pygame.transform.scale(img_main, (screen_w, screen_h))
img_left = pygame.image.load('lab_7\\mouse\\leftarm.png')
img_left = pygame.transform.scale(img_left, (45, screen_h))
img_right = pygame.image.load('lab_7\\mouse\\rightarm.png')
...
def print_time():
    font = pygame.font.Font('lab_7\\mouse\\Alice-Regular.ttf', 40)
