...
with open('paint/color.json') as f:
...
# PEN:
def update_pen():
    pen_image = pygame.image.load('paint/pencil.png')
...
# ERASER:
def update_eraser():
    eraser_image = pygame.image.load('paint/eraser.png')
    TOOL_BUTTONS['eraser'].surf.blit(eraser_image, (10, 10))

# FILL:
def update_fill():
    fill_image = pygame.image.load('paint/fill.png')
